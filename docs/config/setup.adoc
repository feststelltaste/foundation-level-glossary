...
ifeval::["{language}" == "DE"]
:curriculum-header-title: Inoffizieller Glossar für Begriffe rund um Softwarearchitektur im Foundation Level
endif::[]

ifeval::["{language}" == "EN"]
:curriculum-header-title: Inofficial Glossary of Software Architecture Terminology for Foundation Level
endif::[]
