...
Errors or omissions can also be reported in our issue tracker on link:https://github.com/feststelltaste/foundation-level-glossary/issues[GitHub], where the authors maintain the original sources for this book.
...
Sie können Fehler oder Auslassungen in unserem Issue-Tracker auf link:https://github.com/feststelltaste/foundation-level-glossary/issues[GitHub] melden, wo wir die Quellen für dieses Buch verwalten.
